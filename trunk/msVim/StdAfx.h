...
#if !defined(AFX_STDAFX_H__DA87B7E7_9D3E_46FD_A05D_79EC6F740C17__INCLUDED_)
#define AFX_STDAFX_H__DA87B7E7_9D3E_46FD_A05D_79EC6F740C17__INCLUDED_
...
void GetLastErrorDescription(CComBSTR& bstr);		// Defined in msVim.cpp
#define VERIFY_OK(f) \
	{ \
		HRESULT hr = (f); \
		if (hr != S_OK) \
...
#endif // !defined(AFX_STDAFX_H__DA87B7E7_9D3E_46FD_A05D_79EC6F740C17__INCLUDED)
