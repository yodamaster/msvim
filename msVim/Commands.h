...
#if !defined(AFX_COMMANDS_H__6E2BE9FB_7B34_4CBA_8B6D_34DB7D42C1DD__INCLUDED_)
#define AFX_COMMANDS_H__6E2BE9FB_7B34_4CBA_8B6D_34DB7D42C1DD__INCLUDED_

#include "msVimTypes.h"

class CCommands : 
	public CComDualImpl<ICommands, &IID_ICommands, &LIBID_MsVim>, 
...
protected:
	...
	class XApplicationEvents : public XEventHandler<IApplicationEvents, 
		&IID_IApplicationEvents, &LIBID_MsVim, 
	...
	class XDebuggerEvents : public XEventHandler<IDebuggerEvents, 
		&IID_IDebuggerEvents, &LIBID_MsVim, 
...
#endif // !defined(AFX_COMMANDS_H__6E2BE9FB_7B34_4CBA_8B6D_34DB7D42C1DD__INCLUDED)
