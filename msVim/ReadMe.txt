========================================================================
       DEVELOPER STUDIO ADD-IN : msVim
========================================================================


The Add-in Wizard has created this msVim DLL for you.  This DLL not only
...
msVim.cpp
	This is the main DLL source file.  It contains the class CMsVimApp.
...
Commands.cpp, Commands.h
    ...
    a sample command (MsVimCommand) which displays a message
...
StdAfx.h, StdAfx.cpp
    ...
    named msVim.pch and a precompiled types file named StdAfx.obj.
