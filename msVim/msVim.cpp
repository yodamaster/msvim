// msVim.cpp : Defines the initialization routines for the DLL.
//
...
class CMsVimApp : public CWinApp
{
public:
	CMsVimApp();
...
BEGIN_MESSAGE_MAP(CMsVimApp, CWinApp)
	//{{AFX_MSG_MAP(CMsVimApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CMsVimApp object

CMsVimApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CMsVimApp construction
...
/////////////////////////////////////////////////////////////////////////////
// CMsVimApp initialization

BOOL CMsVimApp::InitInstance()
{
	_Module.Init(ObjectMap, m_hInstance);
	return CWinApp::InitInstance();
}

int CMsVimApp::ExitInstance()
{
	_Module.Term();
...
STDAPI DllRegisterServer(void)
{
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_MSVIM_DESCRIPTION);
